...
name: hanhua-skill
description: |
  汉化skill。去除中文文本中的 AI 生成痕迹。适用于编辑、审阅、润色、改写中文文本，使其听起来更自然、更像人类书写。
  当用户提到“汉化skill”“Humanizer-zh”“中文 humanizer”“去 AI 味”“改得像人写的”“润色中文文案”时使用。
...
allowed-tools:
  ...
  - AskUserQuestion
metadata:
  trigger: 汉化skill；编辑或审阅中文文本，去除 AI 写作痕迹
  source: op7418/Humanizer-zh；翻译自 blader/humanizer，参考 hardikpandya/stop-slop
---
